...
def render_footer_nav():
    ...
    # 各項目のHTMLリンクを生成
    # ※ `target="_self"` を指定することで、同一タブ内でStreamlitをリロード（遷移）させます
    links_html = ""
    ...
    .custom-sticky-footer .nav-item {{
        ...
        color: #5f6368 !important; /* 通常時のアイコン色（secondary相当） */
    ...
    /* アクティブ（現在選択中）のボタンのスタイル（primary相当） */
    .custom-sticky-footer .nav-item.active {{
        color: #ff4b4b !important; /* Streamlitのデフォルトの赤（テーマカラーに変えてもOK） */
    }}
